...
import { idlFactory } from './secret_backend.did.js';
export { idlFactory } from './secret_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SECRET_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./secret_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the secret_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./secret_backend.did.js")._SERVICE>}
 */
export const secret_backend = createActor(canisterId);
