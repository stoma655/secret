...
import { idlFactory } from './secret_frontend.did.js';
export { idlFactory } from './secret_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SECRET_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./secret_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the secret_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./secret_frontend.did.js")._SERVICE>}
 */
export const secret_frontend = createActor(canisterId);
